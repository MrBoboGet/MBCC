...
Literal ParseLiteral_0(MBCC::Tokenizer& Tokenizer)
{
    ...
    {
         throw MBCC::ParsingException(Tokenizer.Peek().Position,"Literal","Literal_Bool");
    }
    return(ReturnValue);
}
...
DefaultValue ParseDefaultValue_0(MBCC::Tokenizer& Tokenizer)
{
    ...
    {
         throw MBCC::ParsingException(Tokenizer.Peek().Position,"DefaultValue","Literal");
    }
    return(ReturnValue);
}
...
Attribute ParseAttribute_0(MBCC::Tokenizer& Tokenizer)
{
    ...
    {
         throw MBCC::ParsingException(Tokenizer.Peek().Position,"Attribute","Attribute_Flag");
    }
    return(ReturnValue);
}
Attribute ParseAttribute_1(MBCC::Tokenizer& Tokenizer)
{
    ...
    {
         throw MBCC::ParsingException(Tokenizer.Peek().Position,"Attribute","Attribute_Value");
    }
    return(ReturnValue);
}
...
Attribute ParseAttributeArgument_0(MBCC::Tokenizer& Tokenizer)
{
    ...
    {
         throw MBCC::ParsingException(Tokenizer.Peek().Position,"AttributeArgument","Attribute");
    }
...
MemberDefinition ParseMemberDefinition_Base_0(MBCC::Tokenizer& Tokenizer)
{
    ...
    {
         throw MBCC::ParsingException(Tokenizer.Peek().Position,"MemberDefinition_Base","MemberDefinition_Struct");
    }
    return(ReturnValue);
}
MemberDefinition ParseMemberDefinition_Base_1(MBCC::Tokenizer& Tokenizer)
{
    ...
    {
         throw MBCC::ParsingException(Tokenizer.Peek().Position,"MemberDefinition_Base","MemberDefinition_List");
    }
    return(ReturnValue);
}
...
MemberDefinition ParseMemberDefinition_Member_0(MBCC::Tokenizer& Tokenizer)
{
    ...
    {
         throw MBCC::ParsingException(Tokenizer.Peek().Position,"MemberDefinition_Member","MemberDefinition_Base");
    }
    DefaultValue DefValue;
    if(LOOKTable[10][0][Tokenizer.Peek().Type]&& LOOKTable[10][1][Tokenizer.Peek(1).Type])
    {
        DefValue = ParseDefaultValue(Tokenizer);
    }
    ...
    Tokenizer.ConsumeToken();
    ReturnValue.GetBase().DefValue = std::move(DefValue);
    return(ReturnValue);
}
...
MemberDefinition ParseMemberDefinition_0(MBCC::Tokenizer& Tokenizer)
{
    ...
    {
        Attributes = ParseAttributeList(Tokenizer);
    }
    ...
    {
         throw MBCC::ParsingException(Tokenizer.Peek().Position,"MemberDefinition","MemberDefinition_Member");
    }
    ReturnValue.GetBase().Attributes = std::move(Attributes);
    return(ReturnValue);
}
